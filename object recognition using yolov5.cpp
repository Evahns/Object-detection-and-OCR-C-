...
int main()
{
   // Start OCR
    ...
    Pix* image = pixRead("D:/computer vision/OCR/Resources/Test3.png");
    api->SetImage(image);
    // Get OCR result
    outText = api->GetUTF8Text();
    cout << "EXTRACTED TEXT FROM INPUT CAPTURE:     \n" << outText << endl;
    //printf("OCR output:\n%s", outText);
    ...
    */
    ...
    ifstream ifs("Resources/coco.names");
    string line;
    ...
    while (cap.read(frame))
    {
        ...
        Mat img = post_process(frame_clone, detections, class_names);

        imshow("Real-time Object Detection", img);
